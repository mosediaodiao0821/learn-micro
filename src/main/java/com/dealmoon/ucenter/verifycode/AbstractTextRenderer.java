...
public abstract class AbstractTextRenderer{
	...
	public void draw(String text, BufferedImage canvas, RandomFontFactory fontFactory, ColorFactory colorFactory) {
	...
	protected TextString convertToCharacters(String text, Graphics2D g, RandomFontFactory fontFactory, ColorFactory colorFactory) {
